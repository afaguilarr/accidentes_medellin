...
predicciones_dias <- function(com.or.bar, inicio, final, nombre){
  ...
  if(com.or.bar){
    ...
    #TODO modelos de barrios y sus predicciones
...
```{r}
pruebas <- date_filler_com("Aranjuez", '2019-06-23', '2019-12-31')
#TR_data <- filter(df.comuna, PERIODO!=2018)
tr <- filter(df.comuna, COMUNA=="Aranjuez", PERIODO !=2018)
y <- predict(modelo, newdata = pruebas, data= tr)
```
